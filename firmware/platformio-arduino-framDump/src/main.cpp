...
void loop()
{
        ...
        */ 
        ...
        // Code to dump fram contents 
        Serial.println(F("This Code will dumpt the contents of the fram to the serial monitor."));
        led_r(255); 
        delay(5000); 
        fram.writeEnable(false); 
        led_r(0); 
        Serial.println(F("------START OF DATA DUMP-------"));
        delay(1); 
        for (uint32_t i = 0; i < SRAD_FRAM_WORD_LENGTH; i++)
        {
                led_b(255); 
